    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <!--
                <select class="block mt-1 w-full" id="city" name="city" required autofocus >
                    <option :value="dois_irmaos">Dois Irmãos</option>
                    <option :value="estancia_velha">Estância Velha</option>
                    <option :value="ivoti">Ivoti</option>
                    <option :value="lindolfo_collor">Lindolfo Collor</option>
                </select>
            -->
