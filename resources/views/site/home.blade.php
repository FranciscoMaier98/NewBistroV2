                ...
                <div class="col-lg-8">
                    ...
                    <nav id="menu-pesquisa" class="navbar navbar-expand-lg col-12">
                        ...
                        <div>
                            @if(!(session()->exists("carro")))
                                <div>
                                    <img class="mr-3" width="80" height="80" src="../../imagens/barca_vazia.png" alt="barca_vazia">
                                </div>
                            @else
                                <div>
                                    <img class="mr-3" width="110" height="110" src="../../imagens/barca_cheia2.png" alt="barca_vazia">
                                </div>
                            @endif
                    ...
                    <div >
                        <div class="col-12 d-flex justify-content-between" id="area-pesquisa">
                            <input autocomplete="off" type="text" name="pesquisa" placeholder="Procure algum produto" class="input-search form-control border-0 fs-s p-xs-0 bg-light-gray px-xs-5 fs-1-4">
